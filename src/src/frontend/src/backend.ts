...
export class Backend implements backendInterface {
    ...
    async submitContact(arg0: string, arg1: string, arg2: string | null, arg3: string | null, arg4: string): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.submitContact(arg0, arg1, to_candid_opt_n5(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n5(this._uploadFile, this._downloadFile, arg3), arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_record_n3(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        companyName: record_opt_to_undefined(from_candid_opt_n4(_uploadFile, _downloadFile, value.companyName)),
        phoneNumber: record_opt_to_undefined(from_candid_opt_n4(_uploadFile, _downloadFile, value.phoneNumber))
    };
}
